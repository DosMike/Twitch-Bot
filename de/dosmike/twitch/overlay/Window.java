package de.dosmike.twitch.overlay;
...
import de.dosmike.twitch.overlay.sprites.Sprite;
	...
	public Window() {
		...
		contentPane = new JPanel() {
			...
			public void paintComponent(Graphics g) {
				...
				setTitle("Knarf Overlay Renderer");// " + (int)(1000.0/deltaTime) + "FPS, dt=" + deltaTime + ", last=" + System.currentTimeMillis()%1000);
